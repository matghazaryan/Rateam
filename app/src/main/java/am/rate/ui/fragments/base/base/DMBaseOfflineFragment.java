...
public abstract class DMBaseOfflineFragment<Application extends DMBaseApplication, ViewModel extends DMBaseViewModel<Application>, Binding extends ViewDataBinding> extends DMBaseFragment<Application, ViewModel, Binding> {
